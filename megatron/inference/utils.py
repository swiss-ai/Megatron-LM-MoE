...
try:
    ...
    # This fork still exposes the equivalent native Mamba builder name.
    try:
        from megatron.post_training.model_builder import modelopt_gpt_mamba_builder as modelopt_gpt_hybrid_builder
    except ImportError:
        modelopt_gpt_hybrid_builder = None

HAS_NVIDIA_MODELOPT = modelopt_gpt_hybrid_builder is not None
