...
def validate_args(args, defaults={}):
    ...
    if args.overlap_param_gather:
        assert args.use_distributed_optimizer or args.use_megatron_fsdp \
            or args.optimizer == 'dist_muon' or args.optimizer == 'md_decoupling', \
            '--overlap-param-gather only supported with distributed optimizer, megatron fsdp, dist_muon, or layer-wise distributed optimizer'
